...
import { CATEGORIES, TABLE_SUBCATEGORIES, QUESTION_BANK } from '../data/questionBank'
import { buildSession } from '../engine/session'
import { replayAttempts } from '../engine/scheduler'
import { saveSession, getCardStates, migrateAttemptsToCardState } from '../db/index'
...
export default function SessionSetup() {
  ...
  async function startSession() {
    ...
    // Seed FSRS state from legacy attempts if this is the first run after upgrade.
    const byId = {}
    for (const q of QUESTION_BANK) byId[q.id] = q
    await migrateAttemptsToCardState(replayAttempts, byId)
